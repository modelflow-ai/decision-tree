<br/>
<div align="center">
 <img alt="Decision Tree Logo" src="https://avatars.githubusercontent.com/u/152068817?s=768&amp;v=4" width="200" height="200">
</div>
...
<div align="center">
A decision tree represents a series of decisions and the possible outcome of those decisions. In modelflow-ai we use
decision trees to decide which adapter is responsible to the request.
</div>
...
To install the Decision Tree package, you need to have PHP 8.2 or higher and Composer installed on your machine. Then,
